...
const INITIAL_PATIENTS = [
  ...
  {
    id: "P002", name: "anuja", age: 52, email: "anuja@email.com",
    reports: [
      {
...
const passStrength = (p) => {
  ...
  if (p.length < 6)  return { label: "Weak",     color: "#9CA3AF", w: "25%" };
  if (p.length < 10) return { label: "Moderate", color: "#6B7280", w: "60%" };
  return                    { label: "Strong",   color: "#4B5563", w: "100%" };
};
    ...
    <div className="auth-wrap">
      ...
      <div className={`auth-card${isReg ? " wide" : ""}`}>
        ...
        <div className="auth-logo">
          ...
          <div className="auth-logo-title">TRITINA</div>
